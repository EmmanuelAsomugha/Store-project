...
public class MainWin extends JFrame {
    ...
    public MainWin(String title) {
        ...
        JButton anewButton  = new JButton(new ImageIcon("gui/resources/New_Store.png"));
        ...
        JButton openButton  = new JButton(new ImageIcon("gui/resources/Open_Store.png"));
        ...
        saveButton  = new JButton(new ImageIcon("gui/resources/Save_store.png"));
        ...
        saveAsButton  = new JButton(new ImageIcon("gui/resources/Saveas_Store.png"));
    ...
    protected void onAboutClick() {                 // Display About dialog
        ...
        JLabel artists = new JLabel("<html>"
                ...
                + "<br/><p>logo Store icon based on work by Dreamstate per the Flaticon License</p>"
                + "<p><font size=-2>https://www.flaticon.com/free-icon/clipboard_1735052</font></p>"
                ...
                + "<p><font size=-2>https://www.flaticon.com/free-icon/sort_10396874</font></p>"
                ...
                + "<br/><p>View Orders icon based on work by Futuer per the Flaticon License</p>"
                + "<p><font size=-2>https://www.flaticon.com/free-icon/clipboard_839860?</font></p>"
